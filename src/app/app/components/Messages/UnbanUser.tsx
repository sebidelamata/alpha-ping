...
const UnbanUser:React.FC<UnbanUserProps> = ({
    user,
    username,
    profilePic
}) => {
        ...
        if(error !== null && (error as ErrorType).reason !== undefined){
            toast({
                ...
                description: (username !== null && username !== '') ?
                    ...
                    `Unban ${user.slice(0, 4)}...${user.slice(38,42)} Not Completed!`,
                duration:5000,
                action: (
            ...
            if(txMessage !== null){
                toast({
                    ...
                    description: (username !== null && username !== '') ?
                        ...
                        `Unban ${user.slice(0, 4)}...${user.slice(38,42)} Completed!`,
                    duration:5000,
                    action: (
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription className="flex flex-col items-center justify-center gap-4">
                        They be able to post or interact with posts on this Channel again. 
                    </DialogDescription>
                    <Separator/>
                    <form
